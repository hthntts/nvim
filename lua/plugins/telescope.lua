...
return {
  ...
  keys = {
    ...
    { '<leader>hl',       '<cmd>Telescope highlights<cr>',           desc = 'Highlight' },
    { '<leader>hn',       '<cmd>Telescope notify<cr>',               desc = 'Notify' },
    { '<leader>ht',       '<cmd>Telescope colorscheme<cr>',          desc = 'Themes' },

    {
      '<leader>ie',
      "<cmd>lua require'telescope.builtin'.symbols(require('telescope.themes').get_dropdown({previewer=false}))<cr>",
      desc = 'Emoji'
    },
